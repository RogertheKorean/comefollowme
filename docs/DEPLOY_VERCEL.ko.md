...
질문의 선택 사항인 포스터와 공과 선택에는 마이그레이션 **008**이 필요하며, 현재 프로젝트에는 2026-09-14 적용했습니다. 일반 방문자는 게시된 질문에 연결된 포스터만 볼 수 있고, 작성자·관리자는 자신의 권한 범위에서 비공개 업로드를 관리합니다. 적용된 001~008은 CLI 이력과 대조한 뒤 후속 마이그레이션을 진행하세요.
